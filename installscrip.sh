...
sleep 3s
sudo git clone https://github.com/javbvier/l10n_cl_dte_exportacion.git
sudo git clone https://github.com/javbvier/l10n_cl_dte_factoring.git
sudo git clone https://github.com/javbvier/l10n_cl_dte_point_of_sale.git
sudo git clone https://github.com/javbvier/l10n_cl_fe.git
sudo git clone https://github.com/javbvier/l10n_cl_stock_picking.git
#sudo git clone --branch 11.0 https://gitlab.com/odoocoop/odoo_pasarelas_de_pago/-/tree/11.0/payment_webpay.git
